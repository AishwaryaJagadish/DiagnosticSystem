...
with st.sidebar:
    selected = option_menu('Multiple Disease Diagnosis System',['Diabetes Prediction','Heart Disease Prediction','Parkinsons Prediction'],icons=['activity','heart','person'],default_index=0)
